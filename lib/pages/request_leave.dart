...
class _RequestLeavePageState extends State<RequestLeavePage> {
    ...
    if (leaveDetails.isNotEmpty){
      return ListView.builder(
        ...
        itemBuilder: (context,index){
          return LeaveCard(leaveDetails: leaveDetails[index],onDelete: onleaveDelete,onLeaveStatusUpdate: onleaveStatusUpdated,);
        }
      );
    }
  ...
  Future getuserLeave()async {
    final res=await NetworkService.sendRequest(path: '/user/leave', context: context);
        ...
        child: Column(
          children: [
            ...
            Expanded(
              ...
              : TabBarView(
                  children: [
                    RequestLeaveAdd(onLeaveAdded: (addedLeave)=> setState(() {
                      waitingList.insert(0,addedLeave);
                    })),
